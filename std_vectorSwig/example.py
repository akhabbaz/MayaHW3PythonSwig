...
class VecVector(_object):
    ...
    def iterator(self):
        return _example.VecVector_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _example.VecVector___nonzero__(self)

    def __bool__(self):
        return _example.VecVector___bool__(self)

    def __len__(self):
        return _example.VecVector___len__(self)

    def __getslice__(self, i, j):
        return _example.VecVector___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _example.VecVector___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _example.VecVector___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _example.VecVector___delitem__(self, *args)

    def __getitem__(self, *args):
        return _example.VecVector___getitem__(self, *args)

    def __setitem__(self, *args):
        return _example.VecVector___setitem__(self, *args)

    def pop(self):
        return _example.VecVector_pop(self)

    def append(self, x):
        return _example.VecVector_append(self, x)

    def empty(self):
        return _example.VecVector_empty(self)

    def size(self):
        return _example.VecVector_size(self)

    def swap(self, v):
        return _example.VecVector_swap(self, v)

    def begin(self):
        return _example.VecVector_begin(self)

    def end(self):
        return _example.VecVector_end(self)

    def rbegin(self):
        return _example.VecVector_rbegin(self)

    def rend(self):
        return _example.VecVector_rend(self)

    def clear(self):
        return _example.VecVector_clear(self)

    def get_allocator(self):
        return _example.VecVector_get_allocator(self)

    def pop_back(self):
        return _example.VecVector_pop_back(self)

    def erase(self, *args):
        return _example.VecVector_erase(self, *args)

    def __init__(self, *args):
        this = _example.new_VecVector(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def push_back(self, x):
        return _example.VecVector_push_back(self, x)

    def front(self):
        return _example.VecVector_front(self)

    def back(self):
        return _example.VecVector_back(self)

    def assign(self, n, x):
        return _example.VecVector_assign(self, n, x)

    def resize(self, *args):
        return _example.VecVector_resize(self, *args)

    def insert(self, *args):
        return _example.VecVector_insert(self, *args)

    def reserve(self, n):
        return _example.VecVector_reserve(self, n)

    def capacity(self):
        return _example.VecVector_capacity(self)
    __swig_destroy__ = _example.delete_VecVector
    __del__ = lambda self: None
VecVector_swigregister = _example.VecVector_swigregister
...
def growlist(x):
    return _example.growlist(x)
growlist = _example.growlist
